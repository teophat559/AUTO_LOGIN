...
const Dashboard: React.FC = () => {
  ...
  const activityColumns = [
    { header: t('admin.activity.user'), accessor: 'user' },
    { header: t('admin.activity.action'), accessor: 'action' },
    { header: t('admin.activity.timestamp'), accessor: 'timestamp' },
    {
      header: t('admin.activity.status'),
      accessor: 'status',
      render: (value: string) => (
        <span
          style={{
            color: value === 'Success' ? theme.colors.success : theme.colors.error,
          }}
        >
          {value}
        </span>
