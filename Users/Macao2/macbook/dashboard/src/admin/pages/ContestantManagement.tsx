...
const ContestantManagement: React.FC = () => {
  ...
  const columns = [
    {
      header: t('admin.contestants.thumbnail'),
      accessor: 'thumbnail',
      render: (value: string) => <Thumbnail src={value} alt="Thumbnail" />,
    },
    { header: t('admin.contestants.name'), accessor: 'name' },
    { header: t('admin.contestants.email'), accessor: 'email' },
    { header: t('admin.contestants.contest'), accessor: 'contest' },
    { header: t('admin.contestants.submission'), accessor: 'submission' },
    {
      header: t('admin.contestants.status'),
      accessor: 'status',
      render: (value: string) => <StatusBadge status={value}>{value}</StatusBadge>,
    },
    { header: t('admin.contestants.votes'), accessor: 'votes' },
    { header: t('admin.contestants.submitted_at'), accessor: 'submittedAt' },
    {
      header: t('admin.contestants.actions'),
      accessor: 'actions',
