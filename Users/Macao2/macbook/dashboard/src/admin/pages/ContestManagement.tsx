...
const ContestManagement: React.FC = () => {
  ...
  const columns = [
    { header: t('admin.contests.title'), accessor: 'title' },
    { header: t('admin.contests.description'), accessor: 'description' },
    { header: t('admin.contests.start_date'), accessor: 'startDate' },
    { header: t('admin.contests.end_date'), accessor: 'endDate' },
    {
      header: t('admin.contests.status'),
      accessor: 'status',
      render: (value: string) => <StatusBadge status={value}>{value}</StatusBadge>,
    },
    { header: t('admin.contests.contestants'), accessor: 'totalContestants' },
    { header: t('admin.contests.votes'), accessor: 'totalVotes' },
    {
      header: t('admin.contests.actions'),
      accessor: 'actions',
  ...
  return (
    <ContestManagementContainer>
      ...
      >
        <form onSubmit={handleSubmit} initialValues={selectedContest}>
          <div>
